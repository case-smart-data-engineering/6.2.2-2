...
1 获取文本语料
'''
with open('/workspace/6.2.1-2/1_算法示例/news.txt', 'r', encoding='utf-8') as f:
    news = f.readlines()
...
sentences = word2vec.Text8Corpus('/workspace/6.2.1-2/1_算法示例/news.txt')  # 将语料保存在sentence中
...
workers: 训练的并行个数
'''
model.save('/workspace/6.2.1-2/1_算法示例/text_word2vec.model')  # 保存模型

'''
3 加载模型，实现各个功能
'''
# 加载模型
model = word2vec.Word2Vec.load('/workspace/6.2.1-2/1_算法示例/text_word2vec.model')
...
model.save('/workspace/6.2.1-2/1_算法示例/text_word2vec.model')
